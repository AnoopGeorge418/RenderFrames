...
import CloseMenu from "../assets/Icons/Close.png"; // 👈 add this image
        ...
        >
          ...
          <div className="hidden sm:flex space-x-[27px] flex-row list-none">
                ...
                <div className="relative group">
                    <li className="cursor-pointer hover:bg-[#0440A7] hover:bg-clip-text hover:text-transparent">Downloads</li>
